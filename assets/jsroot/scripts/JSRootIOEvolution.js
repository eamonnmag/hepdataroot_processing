...
(function () {
    ...
    JSROOT.R__unzip_header = function (str, off, noalert) {
        ...
        if (!(str.charAt(off) == 'Z' && str.charAt(off + 1) == 'L' && str.charCodeAt(off + 2) == JSROOT.IO.Z_DEFLATED) && !(str.charAt(off) == 'C' && str.charAt(off + 1) == 'S' && str.charCodeAt(off + 2) == JSROOT.IO.Z_DEFLATED) && !(str.charAt(off) == 'X' && str.charAt(off + 1) == 'Z' && str.charCodeAt(off + 2) == 0)) {
    ...
    JSROOT.TBuffer.prototype.ntof = function () {
        ...
        var inString = this.b.substring(this.o, this.o + 4);
        this.o += 4;
    ...
    JSROOT.TBuffer.prototype.ntod = function () {
        ...
        var inString = this.b.substring(this.o, this.o + 8);
        this.o += 8;
    ...
    // ctor
    JSROOT.TFile = function (data_or_url, newfile_callback) {
        if (!(this instanceof arguments.callee)) {
            var error = new Error("you must use new to instantiate this class");
        ...
        this.fOffset = 0;
        this.fEND = 0;
        this.fFullURL = data_or_url;
        this.fURL = data_or_url;
    ...
    JSROOT.TFile.prototype.ReadBuffer = function (len, callback) {
        ...
        function read_callback(res) {
            if ((res == null) && file.fUseStampPar && (file.fOffset == 0)) {
                ...
                xhr2.send(null);
                return;
            } else if ((res != null) && (file.fOffset == 0) && (file.fFileContent.length == 0)) {
